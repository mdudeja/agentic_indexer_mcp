...
/** Registers a tool to retrieve the full source code definition of a symbol, allowing users to fetch the definition using either a symbol ID or a combination of name and file path. */
